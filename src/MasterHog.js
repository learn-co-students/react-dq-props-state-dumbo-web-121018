...
export default class MasterHog extends Component {
  ...
  render() {
    let hoglist = this.state.offspring.map(hog => <BabyHog hog={hog} eyeColor={this.state.eyeColor} />)
    return (
      <div>

        <input type="radio" name="eyeColor" value="blue" onChange={this.changeEyeColor} checked={this.state.eyeColor === 'blue' && 'checked'} />
        Blue<br></br>
